     ...
     <span className="text-blue hover:text-indigo-700 transition-all mt-2 text-xl ">Cliquez sur l'image pour regarder la vidéo </span>
        ...
        <div className="py-10 w-1/2 max-lg:w-7/12 max-md:w-full space-y-4 p-5 rounded-lg bg-jauneOr/5 text-sm flex flex-col items-start justify-around">
          <p className="text-3xl max-lg:text-2xl max-md:text-xl font-dmserif text-blue">
            Donnez à votre enfant les clés pour définir son projet et réussir
            Parcoursup avec confiance.
          </p>
          <p className="text-base max-md:text-sm">
            ... Le Pack Trajectoire est conçu pour offrir un accompagnement
            complet et structuré, depuis la découverte du profil et des intérêts
            de votre enfant jusqu’à la sélection précise de formations et
            d’établissements. Un parcours en plusieurs étapes pour avancer avec
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-5 my-6 mx-5 md:mx-20">
        <div className="space-y-5 w-full md:w-9/12">
          <Title text1="Objectif du pack" text2="trajectoire" text3="(690€)" />

          <p className="text-blue font-lato">
            Aider votre enfant à mieux se connaître, clarifier son projet,
            identifier les parcours qui lui correspondent et préparer Parcoursup
            avec sérénité
          </p>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-4 text-sm">
              <ul>
                <Coche text3="4. Séance d'échange " />
              </ul>
              <ul>
        ...
        <div className="space-y-5 ml-20 max-sm:mx-2 max-[1100px]:w-3/5 max-[740px]:w-4/5   w-6/12 shrink-0  p-6 rounded-xl bg-white/80">
          ...
          <ul className="text-blue text-lg space-y-2">
            <li className="max-md:text-xs space-x-2 flex items-baseline">
              ...
              <p>Une meilleure connaissance de lui-même et de ses atouts.</p>
            </li>
            <li className="max-md:text-xs space-x-2 flex items-baseline">
              <GoPlus className="text-jauneOr inline mr-1 " />{" "}
              <p> Un projet professionnel affiné et validé</p>
            </li>
            <li className="max-md:text-xs space-x-2 flex items-baseline">
              <GoPlus className="text-jauneOr inline mr-1 " />{" "}
              <p>
                Un choix d’études clair et une stratégie solide pour Parcoursup.
              </p>
            </li>
          </ul>
      ...
      <div className="  ml-16   flex items-center justify-center gap-20  max-sm:space-x-0 my-20 ">
        ...
        <div className="  w-6/12  space-y-5 max-sm:flex max-sm:flex-col max-sm:items-center max-sm:justify-center flex flex-col ">
          ...
          <div className="space-x-6 max-sm:flex max-sm:flex-col max-sm:items-center max-sm:space-x-0 max-sm:space-y-6 ">
            <Link to="/exploration" className=" inline max-lg:text-xs text-white text-sm space-x-2   bg-jauneOr py-3 px-5  font-montserrat font-semibold  rounded-lg hover:bg-jauneOr/80      ">
