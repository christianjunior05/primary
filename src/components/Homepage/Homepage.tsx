      ...
      <header>
        <div className="bg-homepage h-[500px] bg-cover bg-center flex items-center px-6 md:px-20">
          <div className="text-white font-dmserif max-w-full space-y-7  ">
            ...
            <a
              href="#DecouvrirNosOffres"
              className=" inline-block cursor-pointer max-lg:text-xs text-white text-sm space-x-2   bg-jauneOr py-3 px-5  font-montserrat font-semibold  rounded-lg hover:bg-jauneOr/80      "
            >
        ...
        <div className="flex justify-center items-center my-10 pt-11  gap-10 ">
          ...
          <div className=" w-1/2 space-y-5">
            <h5 className="text-4xl font-dmserif text-blue">
              Choisir son orientation, <br />
              <span className="text-jauneOr">
                ce n’est pas tirer au sort une filière
              </span>{" "}
            </h5>
            <p className="w-full md:w-10/12 leading-relaxed text-base md:text-lg text-blue">
              <span className="text-jauneOr">Notre méthode des 3 P </span>:
              simple, claire, efficace
            </p>
            <p>
              Grâce à la méthode des 3 P, l’orientation devient une progression
              simple et constructive, du premier questionnement jusqu’au projet
              abouti.
            </p>
            ...
            <div className="space-y-3">
              <div className="space-x-2">
                ...
                <i className="fa-solid fa-graduation-cap text-jauneOr flex-shrink-0"></i>{" "}
                <span>1. Personnalité : révéler qui je suis </span>
              </div>
              <p>
                Découvrir ses talents, ses forces, ses centres d’intérêt.
                Apprendre à mieux se connaître pour construire un projet qui a
                du sens.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="space-x-2">
                ...
                <i className="fa-solid fa-graduation-cap text-jauneOr flex-shrink-0"></i>{" "}
                <span>2. Parcours : explorer mes options </span>
              </div>
              <p>
                Études courtes ou longues ? Université, école, lycée
                professionnel, prépa ? Nous accompagnons à la découverte des
                établissements adaptés au profil du jeune.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="space-x-2">
                ...
                <i className="fa-solid fa-graduation-cap text-jauneOr flex-shrink-0"></i>{" "}
                <span>3. Projet: tracer ma route</span>
              </div>
              <p>
                Rédiger un dossier, préparer un oral, organiser son planning,
                réussir Parcoursup… Nous donnons les clés pour transformer le
                projet en plan concret, pas à pas.
              </p>
            </div>
          </div>
      ...
      <section>
        <div className="   mt-20  my-20 ">
          <div className="text-center  ">
            <h2
              id="DecouvrirNosOffres"
              className="text-blue font-lato font-dmserif  text-4xl max-md:text-center  "
            >
            
              Nos solutions <span className="text-jauneOr">
                d'orientation{" "}
              </span>{" "}
            </h2>
      ...
      <div className=" max-[1000px]:space-y-10  max-[1000px]:flex-wrap max-[1000px]:justify-center  flex justify-between items-center px-20 py-16 bg-jauneOr/15 ">
        <div className="  ">
          <div className=" max-[1000px]:flex max-[1000px]:flex-col  size-full ">
            ...
            <Link
              to="/Blog"
              className=" inline-block  text-white  max-sm:text-xs   mb-5 mt-7   bg-jauneOr py-4 px-5  font-montserrat font-semibold  rounded-lg hover:bg-jauneOr/80      "
            >
              Découvrir le blog
            ...
            <Link
              to="/Blog"
              className=" text-white block  max-sm:text-xs   bg-jauneOr py-4 px-5  font-montserrat font-semibold  rounded-lg hover:bg-jauneOr/80      "
            >
