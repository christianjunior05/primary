    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative w-full h-[320px] bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/header.jpg')" }}>
        ...
        <div className="relative z-10 h-full flex items-center px-6">
          <h1 className="text-white text-4xl font-dmserif">Contact</h1>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div>
            <h2 className="text-3xl  text-blue  font-dmserif mb-4">Écrivez-nous</h2>
            <p className=" mb-6">
            ...
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow">
              ...
              <button type="submit" className="inline-flex items-center justify-center rounded-md bg-jauneOr px-5 py-2 text-white hover:opacity-90">
                Envoyer
              </button>
            </form>
          </div>
