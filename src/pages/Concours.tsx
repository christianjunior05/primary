...
const Concours = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <header className="mt-[82px] h-[400px] bg-concours gb-center bg-cover flex  items-center pl-10 bg-no-repeat ">
      ...
      <div className="size-[25rem] ">
       <video onClick={HandleClick}
          ...
          <div className=" space-y-5  " >
            ...
            <button
              onClick={() => window.location.href = "https://educompetences.com/nos-preparations/stage-commerce-post-bac/"}
      ...
      <section className="py-16 ">
        ...
        <div className=" flex gap-14 m-auto  justify-center  items-center w-10/12 ">
          ...
          <div className=" space-y-5" >
            ...
            <button
              onClick={() => window.location.href = "https://educompetences.com/nos-preparations/stage-ingenieurs-post-bac/"}
              className=" max-lg:text-xs text-white text-sm space-x-2   bg-jauneOr py-3 px-5  font-montserrat font-semibold  rounded-lg hover:bg-jauneOr/80      ">
              En savoir plus
            </button>
      ...
      <section>
        <div className={`  max-sm:pl-5 bg-footer   pl-20 place-content-center  my-10 h-[400px] bg-no-repeat bg-cover `} >
          <div className="  space-y-5 max-md:w-4/5  w-2/5   py-5 pl-10 bg-white/80 rounded-xl">
            <h2 className=" max-sm:text-3xl font-dmserif text-4xl text-blue "> Pour aller plus loin : </h2>
